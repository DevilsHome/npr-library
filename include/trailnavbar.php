...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" style="background:#b8beb1; height:auto;" >
     ...
     <a class="navbar-brand" href="index.php" style="font-size:2vw; height:auto; text-align: center; margin-top:-8%;margin-left:-20px; color:white; font-style:none;">Central Library SLIET Longowal<br>        <br> संत लोंगोवाल इंस्टिट्यूट ऑफ इंजीनियरिंग एंड टेक्नोलॉजी</a>
  </div>
  <ul class="nav navbar-nav" style="margin-left:0%; mARGINB">
            <li><a href="index.php">HOME</a></li>
            <li><a href="book.php">BOOKS</a></li>
            <li><a href="admin_side/feedback.php">FEEDBACK</a></li>
   </ul> 
  <?php
