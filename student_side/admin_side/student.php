...
<div class="container">
	...
	<?php
		...
		{
			$sql=mysqli_query($con,"SELECT id,firstname,lastname,username,email,contact FROM `student` where username like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($con,"SELECT id,firstname,lastname,username,email,contact FROM `student`;");
