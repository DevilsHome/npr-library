  ...
  document.body.style.backgroundColor = "white";
	...
	<div class="srch">
		...
		<form class="navbar-form" method="post" name="form1">
				...
				<input class="form-control" type="text" name="issn_no" placeholder="Enter Book ISSN NO" required="">
...
<div class="w3-container">
  ...
  <a href="mech.php"><button class="w3-button w3-deep-purple">Mechanical</button></a>
	...
	<?php
		...
		{
			$res=mysqli_query($con,"SELECT * FROM `book` join `department` using(depart_id) where depart_id=1 ORDER BY `book`.`name` ASC;");
		...
		if(isset($_POST['submit1']))
		{
			...
			{
				mysqli_query($con,"DELETE from book  where issn_no = '$_POST[issn_no]'; ");
				?>
