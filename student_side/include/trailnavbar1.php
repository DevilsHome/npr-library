...
<nav class="navbar navbar-inverse">
  ...
  <img class="responsive" style="width:110px; margin-right:80%; border-radius: 50%; height:110px; margin-left:40px;margin-top:18px; margin-bottom: 15px; " src="images/pk.jpg">
  ...
  <?php
            ...
            {   ?>
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="student_signup.php"><span class="glyphicon glyphicon-user"> SIGN UP</span></a></li>
              </ul>
                <?php
            }
          ?>           
