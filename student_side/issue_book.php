...
<div id="main">
  ...
  <div class="container">
    ...
    error_reporting();
      if(isset($_SESSION['login_user']))
      {
        $sql="SELECT student.username,firstname,book.issn_no,name,authors,edition,issue,issue_book.return FROM student inner join issue_book ON student.username=issue_book.username inner join book ON issue_book.issn_no=book.issn_no  WHERE issue_book.username ='$_SESSION[login_user]' and issue_book.approve !='' ORDER BY `issue_book`.`return` ASC";
